 ...
 */
   ...
   // Construter that takes inputs
    public PipeType4(double pipeLength, double pipeRadius, int pipeGrade,int pipeColour,int pipeQuantity,
    ...
    public double calculatePrice()
    {
        ...
        //must have inner insulation so 13% is also added for 29% total
        pipeAdditional = pipeAdditional + 0.29;
