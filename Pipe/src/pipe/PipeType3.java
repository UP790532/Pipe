...
public class PipeType3 extends Pipe {
   ...
   // Construter that takes inputs
    public PipeType3(double pipeLength, double pipeRadius, int pipeGrade,int pipeColour,int pipeQuantity,
    ...
    public double calculatePrice()
    {
        ...
        // The pipe has to have 2 colours so 16% is added
        pipeAdditional = pipeAdditional + 0.16;
