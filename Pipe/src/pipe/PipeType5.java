 ...
 */
   ...
   // Construter that takes inputs
    public PipeType5(double pipeLength, double pipeRadius, int pipeGrade,int pipeColour,int pipeQuantity,
    ...
    public double calculatePrice()
    {
        ...
        //pipe has to have 2 colours so 16% is added, however pipe also
        //must have inner insulation so 13% is also added
        //must have outer reinforcement as well so 17% is added for 46% total
        pipeAdditional = pipeAdditional + 0.46;
